...
if "chat_session" not in st.session_state:
    st.session_state.chat_session = model.start_chat(history=[{"role": "model", "parts": [{"text": "I am a Medical Chatbot, feel free to talk to me !"}]}])

# Display the chatbot's title on the page
st.title("🤖 Gemini Pro - Mental Health ChatBot")
